...
export const CommentInput: React.FC<CommentInputProps> = ({
  ...
  return (
    <div
      className={`w-full flex items-start gap-4 bg-blue-100 p-4 rounded-lg relative ${className}`}
      {...props}
    >
      {showEmojiSelector && (
        <div className="z-[9999] absolute left-12 bottom-40">
          <EmojiPicker
      ...
      <button
        className="transition text-blue-800 hover:text-blue-500 hidden md:block"
      ...
      <textarea
        className="flex flex-1 bg-transparent outline-0 relative"
